...
function BottomTabNavigator() {
  return (
    ...
    {/* <Tab.Navigator screenOptions={{tabBarStyle:{backgroundColor:'white',borderRadius:10 , justifyContent: 'center', overflow:'hidden',marginHorizontal:18 , marginBottom:16, height:66 , display:'flex'  ,paddingBottom:8 , flexDirection:'row' , position: "absolute"}}}> */}
      <Tab.Screen 
        name="Punch" 
